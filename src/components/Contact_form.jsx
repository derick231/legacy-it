...
>
  ...
  <div className="relative z-10 flex h-full items-center justify-center text-white">
      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid gap-10 md:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            {/* SOCIAL ICONS */}
            <div>
              <p className="mb-2 font-medium text-gray-700">{t("contact.follow")}</p>
    ...
    <div className="">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d522.4928740420505!2d85.31922862238767!3d27.64477117012532!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2snp!4v1765950577986!5m2!1sen!2snp"   allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" className="w-full md:h-[300px]"></iframe>
      </div>
    </>
  );
