...
import software from "../assets/software3.jpg"
...
<div className="grid md:grid-cols-3 gap-8 ">
  {[
    {
      title: t("software.title1"),
      desc: t("software.desc1")
    },
    {
      title: t("software.title2"),
      desc: t("software.desc2")
    },
   {
      title: t("software.title3"),
      desc: t("software.desc3")
    },
  ].map((item, i) => (
    <div
      key={i}
